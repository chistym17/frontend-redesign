...
const OrderPage = () => {
  ...
  return (
    <div className="min-h-0 h-auto bg-[#141A21] text-white">
      ...
      <div className={`flex-1 transition-all duration-300 ${isMobile ? 'ml-0' : isCollapsed ? 'ml-14' : 'ml-20'} flex items-start justify-center `}>


        {/* Notifications Grid */}
     <div className="w-full">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center px-6 py-2  md:px-0 md:py-0  ">
             {isMobile && !mobileOpen && (
                <button
