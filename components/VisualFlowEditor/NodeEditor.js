      ...
      <div className="flex-1 overflow-y-auto px-3 py-2">
        ...
        {activeTab === 'functions' && (
          <div className="space-y-3">
            ...
            <div 
              className="border border-white/20 rounded-lg p-1"
              style={{
                background: 'rgba(255, 255, 255, 0.04)',
                backdropFilter: 'blur(10px)',
                WebkitBackdropFilter: 'blur(10px)'
            ...
            {formData.functions.length > 0 && (
              <div className="space-y-1.5">
                <div className="text-[10px] font-semibold text-white/60 uppercase">
                  Selected Functions
                </div>
                <div className="space-y-1">
                  {formData.functions.map((func, index) => (
                    <div 
                      key={index} 
                      className="flex items-center justify-between py-1.5 px-2 bg-white/4 border border-white/20 rounded-lg text-xs hover:border-white/30 transition-colors group"
                      style={{
                        background: 'rgba(255, 255, 255, 0.04)',
                        backdropFilter: 'blur(10px)',
                        WebkitBackdropFilter: 'blur(10px)'
                    ...
                    >
                      <span className="text-white font-mono text-[10px]">{func}</span>
                      <button
                        onClick={() => {
