    ...
    <>
      ...
      >
        ...
        <button
          ...
          className="text-xs text-gray-300 hover:text-white transition-colors px-2 py-1 rounded-md flex items-center gap-1"
          style={{
          ...
          lines.map((l, i) => (
            ...
            >
              <div className="flex items-start gap-2">
                <span className="text-gray-400 text-[10px] leading-5 flex-shrink-0">
