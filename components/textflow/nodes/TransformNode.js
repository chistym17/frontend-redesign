...
export default function TransformNode({ id, data, selected }) {
  ...
  return (
    <div
      ...
      className={`px-2 py-1.5 min-w-[110px] rounded-lg border border-amber-500/30 bg-gradient-to-br from-gray-800 to-gray-900 shadow-lg cursor-pointer transition-all hover:shadow-xl hover:shadow-amber-500/20 ${
        selected ? "ring-1 ring-amber-500 ring-offset-2 ring-offset-gray-950" : ""
      }`}
    >
