...
export default function HttpNode({ id, data, selected }) {
  ...
  return (
    <div
      ...
      className={`px-2 py-1.5 min-w-[110px] rounded-lg border-2 border-violet-500/30 bg-gradient-to-br from-gray-800 to-gray-900 shadow-lg cursor-pointer transition-all hover:shadow-xl hover:shadow-violet-500/20 ${
        selected ? "ring-2 ring-violet-500 ring-offset-2 ring-offset-gray-950" : ""
      }`}
    >
